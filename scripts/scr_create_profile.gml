///scr_create_profile(username,password)
var username = argument0
var password = argument1
var url = "http://api.develop.cloudconfidant.com/profileManagementService/webapi/v1/profiles";
var method = "POST";
...
ds_map_add(loginPayload,"deviceId","XXXXXXXXXXXXXXX")
